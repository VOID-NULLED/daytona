...
from daytona_toolbox_api_client.models.session_write_input_request import SessionWriteInputRequest
...
class ProcessApi:
    ...
    def write_input(
        ...
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionWriteInputRequest, Field(description="Input write request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Write input to command

        Write input data to a running command in a session for interactive execution

        :param session_id: Session ID (required)
        :type session_id: str
        :param command_id: Command ID (required)
        :type command_id: str
        :param request: Input write request (required)
        :type request: SessionWriteInputRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._write_input_serialize(
            session_id=session_id,
            command_id=command_id,
            request=request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def write_input_with_http_info(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionWriteInputRequest, Field(description="Input write request")],
    ...
    @validate_call
    def write_input_without_preload_content(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        request: Annotated[SessionWriteInputRequest, Field(description="Input write request")],
